...
const Home = () => {
  const services = [
    ...
    },
    {
      icon: Shield,
      title: "Cybersecurity",
      description: "Security solutions to protect your data and systems.",
      image: securityImage,
    },
    {
      icon: Network,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              From support to security, we provide end-to-end managed IT
              solutions
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                We deliver reliable, secure, and scalable IT solutions that
                empower your business to focus on what matters most - growth and
                innovation.
              </p>
            ...
            <div className="bg-gradient-card rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-muted-foreground mb-6">
                Let's discuss how we can support your IT infrastructure and help
